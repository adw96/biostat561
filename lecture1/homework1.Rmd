...
Due 2:00pm Thursday 5 October via github classroom (instructions below)
...
3. Create an account on `github.com`. Choose a professional-sounding username! 

4. Sign into our virtual classroom at `https://classroom.github.com/classrooms/32249780-biost-561`. Create a repository with your name or github username followed by "-561". eg. "adw96-561" would be ideal for user adw96.

5. Create a folder on your computer for this class, e.g. "Users/name/Documents/coursework/biost561"

6. Copy a blank (or random) pdf to this folder, and call it "homework1.pdf"

7. Initialise a git repository, add the pdf, commit the pdf, and push it to your classroom repository. http://kbroman.org/github_tutorial/pages/init.html is a great resource, as is googling any error messages you get.

8. Work on your response to Questions 1-4 in this folder. Overwrite the blank pdf with your responses. Repeat Step 7 with your actual submission to submit your homework!
...
Euler's formula gives us that $e^{i \pi}+1=0$. Can  `R` calculate this exactly? If not, what's going on? You should research the binary accuracy of `R` to develop your answer.