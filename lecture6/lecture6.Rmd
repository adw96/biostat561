...
1. One of the best R programmers I know is going to teach you about writing R packages (and making them available via git!)
2. ``Advanced track''
    - Search path
    - Environments
    - Namespaces
...
Bryan is going to teach you about the other stuff
...
We know broadly how to create and store objects in R
