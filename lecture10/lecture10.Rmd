...
- i.e. C++ is not vectorized, but certain Rcpp functions are
    ...
    - [http://dirk.eddelbuettel.com/code/rcpp/Rcpp-sugar.pdf](http://dirk.eddelbuettel.com/code/rcpp/Rcpp-sugar.pdf)
...
- Always prototype in R, then translate
    - when starting out, assume nothing about syntax!
...
- You will need
    ...
    - A C++ compiler
        ...
        - Mac: Install `XCode` (takes a lot of memory)
...
- If you work with spatial data/image analysis, it may be worth learning to program in python
...
- Modules extend base functionality
...
- You will usually need the `numpy` library
...
- You can execute a python script on the command line by running `/usr/local/bin/python2.7 myscript.py`
    ...
    - or `python2.7 myscript.py` if it's in your PATH
- You can execute a python script via a shell script (useful for the clusters)
...
- Alternative to RMarkdown: Jupyter Notebooks
    ...
    - Awesome tutorial: [https://hub.mybinder.org/user/ipython-ipython-in-depth-6w6758qo/notebooks/binder/Index.ipynb](https://hub.mybinder.org/user/ipython-ipython-in-depth-6w6758qo/notebooks/binder/Index.ipynb)
...
# You can add the following your CV/R\'esum\'e

Skills/Software

- Proficient: R
    - Data analysis: tidyverse (dplyr, tibble, stringr, readr, tidyr), magrittr, \[others from other classes\]
    - Reporting: ggplot2, RMarkdown, knitr
    - Performance: Rcpp, benchmarking, debugging, vectorisation
    - Development: R package creation and maintenance, simulator, RStudio
- Familiar: git, unix, bash, Python, C++, distributed/cluster systems, optimisation algorithms
